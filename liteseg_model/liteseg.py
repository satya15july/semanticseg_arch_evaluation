...
#from liteseg_model import liteseg_shufflenet as shufflenet
#from liteseg_model import liteseg_darknet as darknet
from liteseg_model import liteseg_mobilenet as mobilenet
...
class LiteSeg():
    ...
    def build(backbone_network,modelpath,CONFIG,is_train=True, classes = 30):
        net = mobilenet.RT(n_classes=classes,pretrained=is_train, PRETRAINED_WEIGHTS=CONFIG.PRETRAINED_MOBILENET)
        """        
